...
@Component({
  selector: 'app-inv-transfer-item-details-form',
  templateUrl: './inv-transfer-item-details-form.component.html',
  styles: [`
  .footer {
    position: absolute;
    bottom: 0px;
...
export class InvTransferItemDetailsFormComponent implements OnInit {
  ...
  @Input() INV_TRANSFER_ITEMS_ID = null;
  @Input() formData = null
  ...
  createForm(): void {
    this.invTransferItemsDetailsForm = this._fb.group({
      ...
      INV_TRANSFER_ITEMS_ID: [this.INV_TRANSFER_ITEMS_ID, [Validators.required]],
