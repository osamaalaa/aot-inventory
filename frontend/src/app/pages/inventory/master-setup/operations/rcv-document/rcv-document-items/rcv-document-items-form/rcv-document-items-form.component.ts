...
import { RCV_DOCUMENT_ITEMS_VALIDATION_MESSAGES } from './rcv-document-items-form.validations.messages';
...
@Component({
  selector: 'app-rcv-document-items-form',
  templateUrl: './rcv-document-items-form.component.html',
  styles: [
    `
...
export class RcvDocumentItemsFormComponent implements OnInit {


  form: FormGroup;

  validation_messages: any = RCV_DOCUMENT_ITEMS_VALIDATION_MESSAGES;
