...
@Injectable()
export class ReqDocDetailService implements DetailStrategyInterface {
    primaryKey: string;

    formComponent = ReqDocItemsDetailsFormComponent;
    currLang
    constructor(
    ...
    addDetail(formData: any, DOCUMENT_ID: string): Observable<any> {
        return this.openComp<ReqDocItemsDetailsFormComponent, {
            DOCUMENT_ID: string,
            REQ_DOCUMENT_ITEMS_ID: string,
            formData: any
        }>("Add Detail", ReqDocItemsDetailsFormComponent,
            {
    ...
    updateDetail(REQ_DOCUMENT_ITEMS_ID:string, formData: any, MASTER_ID:string): Observable<any> {
        return this.openComp<ReqDocItemsDetailsFormComponent, {
            ...
            REQ_DOCUMENT_ITEMS_ID: string,
            formData: any
        }>("Update Item", ReqDocItemsDetailsFormComponent,
            {
