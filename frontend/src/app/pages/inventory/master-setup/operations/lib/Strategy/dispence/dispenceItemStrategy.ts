...
@Injectable()
export class DispeneItemsService implements ItemStrategyInterface {
    primaryKey: string;
    ...
    addItem(MASTER_ID:string): Observable<any> {
        return this.openComp<DipsDocItemsFormComponent, {
            DOCUMENT_ID: string | number,
            formData: any
        }>("Add Item", DipsDocItemsFormComponent, {
    ...
    updateItem(formData: any,STORES_ID): Observable<any> {
        return this.openComp<DipsDocItemsFormComponent, {
            ...
            formData: any
        }>("Update Item", DipsDocItemsFormComponent, {
