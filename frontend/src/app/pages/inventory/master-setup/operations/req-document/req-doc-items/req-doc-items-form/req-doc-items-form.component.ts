...
import { REQ_DOC_ITEMS_VALIDATION_MESSAGES } from './req-doc-items.validations.messages';
import { OperationsService } from 'src/app/services/operations.service';
import { ItemsService } from 'src/app/services/items.service';
import { flatMap, switchMap } from 'rxjs/operators';

@Component({
  selector: 'app-req-doc-items-form',
  templateUrl: './req-doc-items-form.component.html',
  styleUrls: ['./req-doc-items-form.component.scss']
})
export class ReqDocItemsFormComponent implements OnInit {
  ...
  @Input() shouldValidateBalance = null;
  @Input() isReturnRequest:boolean;
