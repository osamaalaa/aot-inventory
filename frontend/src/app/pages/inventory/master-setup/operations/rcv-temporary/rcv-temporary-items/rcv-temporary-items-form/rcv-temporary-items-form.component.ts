...
import {  RCV_TEMPORARY_ITEMS_VALIDATION_MESSAGES } from './rcv-temporary-items-form.validations.messages';
...
@Component({
  selector: 'app-rcv-temporary-items-form',
  templateUrl: './rcv-temporary-items-form.component.html',
  styles: [
    `
...
export class RcvTemporaryItemsFormComponent implements OnInit {

 
  form: FormGroup;

  validation_messages: any = RCV_TEMPORARY_ITEMS_VALIDATION_MESSAGES;
