...
import { RCV_TEMP_ITEMS_DETAILS_VALIDATION_MESSAGES } from './rcv-temporary-items-details-form.validations.messages';
...
@Component({
  selector: 'app-rcv-temporary-items-details-form',
  templateUrl: './rcv-temporary-items-details-form.component.html',
  styles:[
    `.footer {
      position: absolute;
      bottom: 0px;
...
export class RcvTemporaryItemsDetailsFormComponent implements OnInit {

  form: FormGroup;

  validation_messages: any = RCV_TEMP_ITEMS_DETAILS_VALIDATION_MESSAGES;

  @Input() RCV_TEMP_ITEMS_ID: string | number;
  ...
  createForm(): void {
    this.form = this._fb.group({
      ...
      RCV_TEMP_ITEMS_ID: [this.RCV_TEMP_ITEMS_ID],
      RCV_TEMP_ITEMS_D_ID: [null],
