...
import { JODISPENCE_ITEMS_DETAILS_VALIDATION_MESSAGES } from './jo-disp-doc-items-details.validation.messages';

@Component({
  selector: 'app-jo-disp-doc-items-details-form',
  templateUrl: './jo-disp-doc-items-details-form.component.html',
  styles:[
    `
    .footer {
      position: absolute;
...
export class JODipsDocItemsDetailsFormComponent implements OnInit {


  form: FormGroup;

  validation_messages: any = JODISPENCE_ITEMS_DETAILS_VALIDATION_MESSAGES;
