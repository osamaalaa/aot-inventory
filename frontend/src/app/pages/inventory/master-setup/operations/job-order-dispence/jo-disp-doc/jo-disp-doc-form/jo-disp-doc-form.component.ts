...
import { DISPENCE_VALIDATION_MESSAGES } from './jo-disp-doc-form.validations.messages';
...
@Component({
  selector: 'app-jo-disp-doc-form',
  templateUrl: './jo-disp-doc-form.component.html',
  styles:[`

  `]
})
export class JODipsDocFormComponent implements OnInit {
