...
import { REQ_DOC_ITEMS_DETAILS_VALIDATION_MESSAGES } from './jo-req-doc-items-details.validation.messages';

@Component({
  selector: 'app-jo-req-doc-items-details-form',
  templateUrl: './jo-req-doc-items-details-form.component.html',
  styleUrls: ['./jo-req-doc-items-details-form.component.scss']
})
export class JOReqDocItemsDetailsFormComponent implements OnInit {
